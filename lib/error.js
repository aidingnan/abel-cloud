...
define('InvalidPhoneNumber', 60003, 'invalid phone number')
...
define('UsernameOrPasswordError', 60008, 'username or password error')
...
define('ShareNotShared', 60108, 'station has not shared to user')
// pipe: 603XX
